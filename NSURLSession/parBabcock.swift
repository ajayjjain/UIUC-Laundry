...
class parBabcock: UIViewController {
    ...
    func parse() {
        let myURLAdress = "https://www.laundryalert.com/cgi-bin/urba7723/LMRoom?XallingPage=LMPage&Halls=19&PreviousHalls=&RoomPersistence=&MachinePersistenceA=&MachinePersistenceB="
