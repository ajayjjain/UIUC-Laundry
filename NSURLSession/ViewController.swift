  ...
  override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject!) {
    ...
    @IBAction func myDorm(sender: AnyObject) {
        ...
        if let name = defaults.stringForKey("dorm") {
            ...
            else if name == "danielsNorth"{
                performSegueWithIdentifier("danielsNorth", sender: nil)
                
            }
            else if name == "danielsSouth"{
                performSegueWithIdentifier("danielsSouth", sender: nil)
                
            }
            else if name == "green"{
                performSegueWithIdentifier("green", sender: nil)
            ...
            else if name == "larLeonard"{
                performSegueWithIdentifier("larLeonard", sender: nil)
                
            }
            else if name == "larShelden"{
                performSegueWithIdentifier("larShelden", sender: nil)
                
            }
            else if name == "parBabcock"{
                performSegueWithIdentifier("parBabcock", sender: nil)
            ...
            else if name == "shermanTall"{
                performSegueWithIdentifier("shermanTall", sender: nil)
                
            }
            else if name == "taft"{
                performSegueWithIdentifier("taft", sender: nil)
                
            }
            else if name == "vanDoren"{
                performSegueWithIdentifier("vanDoren", sender: nil)
