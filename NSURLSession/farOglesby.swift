...
class farOglesby: UIViewController {
    ...
    func parse() {
        let myURLAdress = "https://www.laundryalert.com/cgi-bin/urba7723/LMRoom?XallingPage=LMPage&Halls=6&PreviousHalls=&RoomPersistence=&MachinePersistenceA=&MachinePersistenceB="
