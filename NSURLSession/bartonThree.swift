...
class bartonThree: UIViewController {
    ...
    @IBOutlet weak var machineFifteenStatusLabel: UILabel!
    ...
    @IBOutlet weak var fifteenTimeRemaining: UILabel!
    ...
    @IBAction func labelFifteenPress(sender: AnyObject) {
        if self.machineFifteen != "Available" && machineFifteenStatus != "not updating status"{
            AudioServicesPlayAlertSound(SystemSoundID(kSystemSoundID_Vibrate))
            
            let intString = machineFifteenStatus.componentsSeparatedByCharactersInSet(
                NSCharacterSet
                    .decimalDigitCharacterSet()
                    .invertedSet)
                .joinWithSeparator("")
        ...
        let URLTask = NSURLSession.sharedSession().dataTaskWithURL(myURL!) {
            ...
            if let doc = HTML(html: html!, encoding: NSUTF8StringEncoding) {
                ...
                dispatch_async(dispatch_get_main_queue()) {
                    ...
                    self.machineFifteenStatusLabel.text = self.machineFifteen
                    ...
                    self.fifteenTimeRemaining.text = self.machineFifteenStatus
                    ...
                    if self.machineFifteen == "Available"{
                        self.machineFifteenStatusLabel.textColor = UIColor.greenColor()
                    }
                    else{
                        self.machineFifteenStatusLabel.textColor = UIColor.redColor()
                    }
