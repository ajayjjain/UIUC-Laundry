...
class nugent: UIViewController {
    ...
    func parse() {
        let myURLAdress = "https://www.laundryalert.com/cgi-bin/urba7723/LMRoom?CallingPage=LMPage&Halls=15&PreviousHalls=&RoomPersistence=&MachinePersistenceA=&MachinePersistenceB="
